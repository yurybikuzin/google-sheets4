...
impl<'a> SpreadsheetMethods<'a> {
    ...
    pub fn developer_metadata_get(
        ...
        spreadsheet_id: &str,
        metadata_id: i32,
    ) -> SpreadsheetDeveloperMetadataGetCall<'a> {
    ...
    pub fn developer_metadata_search(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetDeveloperMetadataSearchCall<'a> {
    ...
    pub fn values_batch_clear(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetValueBatchClearCall<'a> {
    ...
    pub fn values_batch_clear_by_data_filter(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetValueBatchClearByDataFilterCall<'a> {
    ...
    pub fn values_batch_get_by_data_filter(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetValueBatchGetByDataFilterCall<'a> {
    ...
    pub fn values_batch_update(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetValueBatchUpdateCall<'a> {
    ...
    pub fn values_batch_update_by_data_filter(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetValueBatchUpdateByDataFilterCall<'a> {
    ...
    pub fn get_by_data_filter(
        ...
        spreadsheet_id: &str,
    ) -> SpreadsheetGetByDataFilterCall<'a> {
...
impl<'a> SpreadsheetDeveloperMetadataGetCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, DeveloperMetadata)> {
        use client::ToParts;
...
impl<'a> SpreadsheetSheetCopyToCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, SheetProperties)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
...
impl<'a> SpreadsheetValueAppendCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, AppendValuesResponse)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
...
impl<'a> SpreadsheetValueBatchClearCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, BatchClearValuesResponse)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
...
impl<'a> SpreadsheetValueBatchGetCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, BatchGetValuesResponse)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn client::Delegate,
    ) -> SpreadsheetValueBatchGetCall<'a> {
        self._delegate = Some(new_value);
        self
    }
...
impl<'a> SpreadsheetValueClearCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, ClearValuesResponse)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
...
impl<'a> SpreadsheetValueUpdateCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, UpdateValuesResponse)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
...
impl<'a> SpreadsheetCreateCall<'a> {
    ...
    pub async fn doit(
        mut self,
    ) -> client::Result<(hyper::Response<hyper::body::Body>, Spreadsheet)> {
        use client::ToParts;
        use hyper::header::{AUTHORIZATION, CONTENT_LENGTH, CONTENT_TYPE, LOCATION, USER_AGENT};
        use std::io::{Read, Seek};
        let mut dd = client::DefaultDelegate;
